...
<body class="font-[Poppins] bg-[#F2F2F2] h-auto fade-in">
    ...
    <div class="mt-10 px-6">
        <form>
            ...
            <label for="file-input" class="w-full h-32 border-2 border-dashed border-[#171717] p-4 rounded-[20px] flex flex-col items-center justify-center mb-4 cursor-pointer">
