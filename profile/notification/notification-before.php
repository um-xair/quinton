...
<body class="font-[Poppins] bg-[#F2F2F2] h-screen fade-in">
    ...
    <div class="mt-10 px-6">
        <h2 class="text-[#171717] text-3xl font-bold mb-4 sm:text-2xl md:text-3xl lg:text-4xl">No new notifications at the moment. Enjoy the quiet!</h2>
        <a href="notification.php">
            <img src="../../assets/bell.png" alt="notification" class="mt-10 w-full mx-auto">
        </a>
    </div>
