...
<div class="w-full bg-[#171717] h-40 rounded-b-[90px] py-4 z-50">
    ...
    <div class="mt-10 px-6">
        <h2 class="text-[#171717] text-3xl font-bold mb-4 sm:text-2xl md:text-3xl lg:text-4xl">Let's get your family connected with Quinton today!</h2>
        <img src="../../assets/family.png" alt="warranty" class="mt-6 w-80 mx-auto sm:w-72 md:w-80 lg:w-96">
    </div>
