...
<body class="font-[Poppins] bg-[#F2F2F2] h-auto">
    ...
    <div class="w-full bg-[#171717] h-40 rounded-b-[90px] py-4 z-50">
        <div class="flex items-center justify-between px-6 h-full">
            <a href="family-after.php" class="w-10 h-10 rounded-full bg-white flex items-center justify-center">
    ...
    <div class="mt-10 px-6 mb-6 flex items-center justify-between">
        <a href="family-after.php" class="inline-block w-[80%] bg-[#232323] py-6 px-10 rounded-full text-white text-lg font-bold text-center sm:text-base md:text-lg lg:text-xl">
            Submit
        </a>
