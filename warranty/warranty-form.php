    ...
    <div class="mt-10 px-6">
        <form>
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" class="w-full p-3 mt-2 rounded-full" required>
            </div>

            <div class="mb-4">
                <label for="phone" class="block text-[#171717] text-md font-semibold">Phone Number</label>
                <input type="tel" id="phone" name="phone" class="w-full p-3 mt-2 rounded-full" required>
            </div>

            <div class="mb-4">
                <label for="email" class="block text-[#171717] text-md font-semibold">Email</label>
                <input type="email" id="email" name="email" class="w-full p-3 mt-2 rounded-full" required>
            </div>

            <div class="mb-4">
                <label for="category" class="block text-[#171717] text-md font-semibold">Product Category</label>
                <div class="bg-[#266FF1] rounded-[20px] p-4 relative mt-2 cursor-pointer" onclick="toggleProductGrid('stroller')">
                    <p class="text-xl font-semibold text-white">Stroller</p>
                </div>
                ...
                <div class="bg-[#684CF0] rounded-[20px] p-4 relative mt-2 cursor-pointer" onclick="toggleProductGrid('carseat')">
                    <p class="text-xl font-semibold text-white">Car Seat</p>
                </div>
                ...
                <div class="bg-[#F6643C] rounded-[20px] p-4 relative mt-2 cursor-pointer" onclick="toggleProductGrid('highchair')">
                    <p class="text-xl font-semibold text-white">High Chair</p>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <input type="text" id="invoiceNumber" name="invoiceNumber" class="w-full p-3 mt-2 rounded-full" required>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center mt-2">
                    <label for="yes" class="mr-4">
                        <input type="radio" id="yes" name="firstQuintonProduct" value="yes" class="mr-2" required> Yes
                    </label>
                    <label for="no">
                        <input type="radio" id="no" name="firstQuintonProduct" value="no" class="mr-2" required> No
                    </label>
                </div>
            </div>
            ...
            <div class="mb-4 flex items-center">
                ...
                <label for="terms" class="text-[#171717] text-md">I have read and agree to the <a href="#" class="text-blue-600">Terms & Conditions</a></label>
            </div>
