...
<body class="font-[Poppins] bg-[#F2F2F2] h-auto">
    ...
    <div class="mt-10 px-6">
        <div class="text-center">
            ...
            <p class="mt-4 text-3xl font-extrabold text-[#171717]">On The Go</p>
            <div class="mt-2 flex justify-center">
                <div class="flex items-center space-x-2">
                    <i class="fa fa-clock text-[#171717] text-sm"></i>
                    <p class="text-sm text-[#171717]">Warranty in progress</p>
                </div>
            </div>
        </div>
